    ...
    <>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <h1>
            ...
            <span className="accent">community action</span>.
          </h1>

          <p>
            NGOConnect empowers citizens and verified NGOs to collaborate on
            real-world change — donate essentials, raise local issues, and
      ...
      <section className="impact-section">
        <div className="impact-grid">
          ...
          <div className="impact-card">
            ...
            <div className="impact-num">₹5L+</div>
      ...
      <section className="features-section">
        <div className="section-head">
          ...
          <p>
            Whether you have time, resources, or a voice — there's a meaningful
        ...
        <div className="feature-grid">
          <div className="feature-card f1">
            ...
            <p>
              Report sanitation, drainage, or civic issues in your area. Track
          ...
          <div className="feature-card f2">
            ...
            <h3>Donate easily</h3>
            <p>
              Contribute money, food, clothes, or medical supplies — securely,
        ...
        <div className="testimonial-grid">
          ...
          <div className="testimonial-card">
            <p className="quote">
              ...
              minutes — and I know exactly where they went.
            </p>
            <div className="testimonial-author">
          ...
          <div className="testimonial-card">
            <p className="quote">
              ...
              teaching drive in 3 days. So fulfilling. ❤️
            </p>
            <div className="testimonial-author">
      ...
      <section className="cta-banner">
        ...
        <p>
          Join thousands of citizens and NGOs creating measurable impact —
          one action at a time.
        </p>
        <Link to="/register" className="btn">
          Join NGOConnect Today →
        </Link>
      </section>
    </>
  );
