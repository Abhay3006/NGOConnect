  ...
  return (
    <div className="dashboard">
      <div className="dashboard-header">
        ...
        <p>{role === "admin" ? "Manage all community reports and volunteer requests." : "Manage your community actions and donations."}</p>
      </div>

      <div className="dashboard-actions">
        {role === "admin" ? (
          <>
            <Link to="/all-complaints" className="action-card">
            ...
            <Link to="/all-donations" className="action-card">
              <div className="card-icon">
            ...
            <Link to="/all-volunteers" className="action-card">
              <div className="card-icon">
            ...
            <Link to="/analytics" className="action-card">
              ...
              <h3>Analytics</h3>
              <p>View system insights and KPIs</p>
            </Link>
          </>
        ) : (
          <>
            <Link to="/complaint" className="action-card">
              <div className="card-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
              </div>
              <h3>Raise Complaint</h3>
              <p>Report a new sanitation issue in your area.</p>
            </Link>
            ...
            <Link to="/my-complaints" className="action-card">
              ...
              <h3>My Complaints</h3>
              <p>Track and view your submitted complaints.</p>
            </Link>

            <Link to="/donation" className="action-card">
              <div className="card-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
              </div>
              <h3>Make Donation</h3>
              <p>Contribute to help our community.</p>
            </Link>

            <Link to="/my-donations" className="action-card">
              <div className="card-icon">
              ...
              <h3>My Donations</h3>
              <p>Track and view your donations.</p>
            </Link>

            <Link to="/volunteer-request" className="action-card">
              <div className="card-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
              </div>
              <h3>Volunteer</h3>
              <p>Join us as a volunteer to serve the community.</p>
            </Link>

            <Link to="/my-volunteers" className="action-card">
              <div className="card-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
              </div>
              <h3>My Volunteer Requests</h3>
